...
- `messages` — gli ultimi N messaggi dal DB **successivi a `covers_until_message_id`** del riassunto attivo (cap: ~20 messaggi o ~8000 token stimati, `chars/3.5`), poi il turno corrente:
